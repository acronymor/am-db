...
MatchAndPickNode::MatchAndPickNode(std::size_t* pick_to, const std::vector<std::shared_ptr<RuleMatcher>>& children,
...
std::vector<std::shared_ptr<RuleMatcher>> MatchAndPickNode::GetChildren() { return this->children_; };
...
MatchNode::MatchNode(const std::vector<std::shared_ptr<RuleMatcher>>& children, const plan::RelOptNodeType& type)
    : RuleMatcher(RuleMatcherType::MatchNode), children_(children), type_(type) {}

std::vector<std::shared_ptr<RuleMatcher>> MatchNode::GetChildren() { return this->children_; }
